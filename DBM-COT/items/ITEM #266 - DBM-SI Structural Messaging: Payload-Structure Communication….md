#ITEM #266 - Structural Messaging Architecture in DBM-SI
...
###6.1 Structural Messaging documentation consists of three layers:
...
Structural Messaging is not defined by transport technology, but by structural state synchronization.
